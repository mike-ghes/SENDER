...
static int is_init = 0;  // adelong -- allow multiple initializations
...
// adelong
GLAPI void APIENTRY hackGenerateMipmap(GLenum target)
{
	printf("ERROR: your video card and/or drivers do not support glGenerateMipmap();\n");
	printf("   see http://www.opengl.org/wiki/Common_Mistakes#Automatic_mipmap_generation\n");
}
...
static void load_procs(void)
{
		...
		// adelong
		if (!gl3wGenerateMipmap)
			gl3wGenerateMipmap = hackGenerateMipmap;
